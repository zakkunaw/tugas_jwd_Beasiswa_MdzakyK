...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE pendaftar SET nama='$nama', email='$email', phone='$phone', semester='$semester', gpa='$gpa' WHERE id='$id'";
...
<body>
    <div class="container mt-5">
        ...
        <form method="post" action="">
            ...
            <div class="form-group">
                <label>IPK</label>
                <input type="text" class="form-control" name="gpa" value="<?php echo $row['gpa']; ?>" required>
            </div>
